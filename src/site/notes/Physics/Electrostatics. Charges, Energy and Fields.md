---
{"dg-publish":true,"permalink":"/physics/electrostatics-charges-energy-and-fields/"}
---
...
[[Problems solved about Electrostatics (Purcell Ch. 1)\|Problems solved about Electrostatics (Purcell Ch. 1)]]
#### Answer to Questions 
---
1) 
$$
...
3) Curl would be zero, which from multivariable calculus [[Conservative Vector Fields\|Conservative Vector Fields]] is equivalent to the fact that the line integral between to two points is the same independent of a path taken.